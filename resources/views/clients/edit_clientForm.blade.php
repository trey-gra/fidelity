...
@section('content')
<div class="col-md-8">
	<form name="editClient" method="post" class="form-horizontal" action="{{url('/client/update_client')}}" >
			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="col-md-6">
						<div class="well well-sm pull-right">
							...
							<input type="text" name="clientid" class="form-control" value="{{$client->id}}">
						</div>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					<div class="col-md-6">
						...
						<input type="text" name="trn" class="form-control" value="{{$client->trn}}">
					</div>
					<div class="col-md-6">
				...
				<div class="row">
					<div class="col-md-6">
						...
						<input type="text" name="tel1" class="form-control" value="{{$client->tel_d}}">
					</div>
					<div class="col-md-6">
						<label class="control-label">Telephone (Mobile)</label>
						<input type="text" name="tel2" class="form-control" value="{{$client->tel_l}}">
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<label class="control-label">Address</label>
						<textarea class="form-control" rows="3" name="address">{{$client->address1}}</textarea>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6">
						...
						<select name="job_id" class="form-control">
							<option value="{{$client->occu->id}}">{{$client->occu->desc}}</option>
							@foreach($occ as $job)
					...
					<div class="col-md-6">
						...
						<select name="parish_id" class="form-control">
							<option value="{{$client->parish->id}}">{{$client->parish->name}}</option>
				...
				<div class="row">
					<div style="padding: 12px 12px 0px 12px;">
						<input type="submit" name="Save" value="Update" class="btn btn-success form-control">
